    ...
    >
      ...
      <div className="flex border-l border-secondary-100/50">
        <button
          ...
          className="w-[77px] border border-transparent rounded-none rounded-r-lg p-4 flex items-center justify-center text-sm font-medium text-primary-500 hover:text-primary-400 focus:outline-none focus:ring-2 focus:text-primary-400"
        >
          Cerrar
        </button>
      </div>
